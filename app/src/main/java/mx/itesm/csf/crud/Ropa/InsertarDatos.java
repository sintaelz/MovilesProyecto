...
import static mx.itesm.csf.crud.Controladores.Servicios.ROPA_UPDATE;
...
public class InsertarDatos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barra_de_progreso = new ProgressDialog(InsertarDatos.this);
    ...
    private void actualizarDatos()
    {
        ...
        StringRequest updateReq = new StringRequest(Request.Method.POST, Servicios.ROPA_UPDATE,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(InsertarDatos.this, "Respuesta : "+   res.getString("Mensaje") , Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        barra_de_progreso.cancel();
                        Toast.makeText(InsertarDatos.this, "Respuesta: Error al insertar datos", Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                map.clear();
                map.put("p_id",clave.getText().toString());
    ...
    private void guardarDatos()
    {
        ...
        barra_de_progreso.show();
                ...
                StringRequest enviaDatos = new StringRequest(Request.Method.POST, Servicios.ROPA_CREATE,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        barra_de_progreso.cancel();
            ...
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                //map.put("clave",clave.getText().toString());
                map.clear();
                map.put("nombre",nombre.getText().toString());
                map.put("imagen",imagen.getText().toString());
                map.put("stock",stock.getText().toString());
