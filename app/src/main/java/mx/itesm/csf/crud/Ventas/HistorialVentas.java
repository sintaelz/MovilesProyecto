...
public class HistorialVentas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barra_de_progreso = new ProgressDialog(HistorialVentas.this);
        ...
        miAdministrador = new LinearLayoutManager(HistorialVentas.this,LinearLayoutManager.VERTICAL,false);
        miRecyclerview.setLayoutManager(miAdministrador);
        miAdaptador = new AdaptadorVentas(HistorialVentas.this,misElementos);
    ...
    private void cargarJSON()
    {
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.GET, Servicios.HISTVENTAS_READ+"?e_id=" + e_id,null,
